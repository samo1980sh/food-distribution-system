@php
    ...
    if ($uploadedFile instanceof TemporaryUploadedFile) {
        $preview = app(UnitExcelImportService::class)->analyze(
...
@if ($preview !== null)
    ...
    <style>
        ...
        .fd-unit-import-preview * { box-sizing: border-box; }
        ...
        .fd-import-metric-label {
            font-size: 11px;
            font-weight: 600;
            color: var(--fd-muted);
        }

        .fd-import-metric-value {
            margin-top: 4px;
            font-size: 22px;
            line-height: 1;
            font-weight: 800;
        ...
        .fd-import-preview-heading {
            font-size: 13px;
            font-weight: 700;
            color: var(--fd-text);
        }

        .fd-import-preview-count {
            font-size: 11px;
            color: var(--fd-muted);
        }

        .fd-import-table-wrap {
            overflow-x: auto;
            border: 1px solid var(--fd-border);
            border-radius: 11px;
            background: #fff;
    ...
    <div class="fd-unit-import-preview">
        <div class="fd-import-shell">
            <div class="fd-import-head">
                <div>
                    <h3 class="fd-import-title">نتيجة فحص الملف</h3>
                    <p class="fd-import-subtitle">تم تحليل الملف كاملًا قبل الحفظ والتحقق من جميع صفوف البيانات.</p>
                </div>
                        ...
                        <table class="fd-import-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>اسم الوحدة</th>
                                    <th class="fd-col-symbol">الاختصار</th>
            ...
            @if ($preview['valid'])
                <div class="fd-import-result is-success">
                    ...
                    <div>
                        ...
                        عند الضغط على «استيراد الملف» ستتم إضافة جميع الصفوف ضمن عملية واحدة، ولن يتم حفظ جزء من الملف منفردًا.
                    </div>
                </div>
            @else
