@php
    ...
    if ($uploadedFile instanceof TemporaryUploadedFile) {
        $preview = app(AreaExcelImportService::class)->analyze(
...
@if ($preview !== null)
    ...
    <style>
        ...
        .fd-area-import-preview * { box-sizing: border-box; }
    ...
    <div class="fd-area-import-preview">
