...
<head>
    ...
    <title>
        مرتجع بيع {{ $salesReturn->return_number }}
    </title>
...
<body>
    ...
    <main class="sheet">
        ...
        <section class="section">
            <h3 class="section-title">بيانات المرتجع</h3>

            <div class="details-grid">
                <div class="detail-item">
                    <span>رقم المرتجع</span>
                    <strong dir="ltr">{{ $salesReturn->return_number }}</strong>
                </div>
                ...
                <div class="detail-item">
                    <span>العميل</span>
                    <strong>{{ $salesReturn->customer?->name ?? '-' }}</strong>
                </div>
                ...
                <div class="detail-item">
                    ...
                    <strong>{{ $salesReturn->warehouse?->name ?? '-' }}</strong>
                </div>
                ...
                <div class="detail-item">
                    ...
                    <strong>{{ $salesReturn->route?->name ?? '-' }}</strong>
                </div>
                ...
                <div class="detail-item">
                    ...
                    <strong>{{ $salesReturn->customer?->address ?: '-' }}</strong>
                </div>
            </div>
        </section>

        <section class="section">
            <h3 class="section-title">مواد المرتجع</h3>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 25px;">
                                لا توجد مواد مسجلة ضمن هذا المرتجع.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
            ...
            <div class="summary">
                <div class="summary-row">
                    ...
                    <strong>{{ $money($salesReturn->subtotal) }}</strong>
                </div>

                <div class="summary-row">
                    <span>الحسم</span>
                    <strong>{{ $money($salesReturn->discount_amount) }}</strong>
                </div>

                <div class="summary-row total">
                    <span>صافي المرتجع</span>
                    <strong>{{ $money($salesReturn->total_amount) }}</strong>
                </div>
            </div>
        </section>

        @if (filled($salesReturn->notes))
            <section class="section">
        ...
        <section class="signatures">
            ...
            <div class="signature">توقيع المستودع</div>
        ...
        <footer class="report-footer">
            ...
            <span>
                ...
                @if ($salesReturn->confirmed_at)
                    —
                    <span dir="ltr">
                        {{ $salesReturn->confirmed_at->format('Y-m-d H:i') }}
                    </span>
                @endif
            </span>
