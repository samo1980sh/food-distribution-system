...
class SalesJourneyResource extends OperationalResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'start_odometer' => $this->start_odometer === null ? null : (int) $this->start_odometer,
            'end_odometer' => $this->end_odometer === null ? null : (int) $this->end_odometer,
            'distance_km' => $this->distance_km === null ? null : (int) $this->distance_km,
